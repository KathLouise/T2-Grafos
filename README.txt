...
Estrutura de Dados:
	...
	- A estrutura do vertice possui nome, sua posição no vetor, uma flag de estado removido, um inteiro que guarda o tamanho do vetor de rotulos, uma flag de estado passado, um vetor de inteiro para guardar os rotulos, duas listas de adjacencias (entrada e saida), e seus graus de entrada e de saida.
